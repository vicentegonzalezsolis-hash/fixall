  ...
  return (
    <div className="pb-8">
      ...
      <div className="flex items-center gap-3 px-4 pt-12 pb-6">
        ...
        <h1 className="text-lg font-bold" style={{ color: "#FAFAFA" }}>Nueva Orden de Trabajo</h1>
      </div>
          ...
          {showSugerencias && sugerencias.length > 0 && (
            <div className="absolute z-20 top-full mt-1 w-full bg-surface-2 border border-border rounded-xl overflow-hidden shadow-xl">
              ...
              <Link
                ...
                className="flex items-center gap-2 px-4 py-3 text-accent text-sm hover:bg-surface border-t border-border"
              >
